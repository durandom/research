...
I try to include prompts and links to transcripts in [the PRs](https://github.com/durandom/research/pulls?q=is%3Apr+is%3Aclosed) that added each report, or in [the commits](https://github.com/durandom/research/commits/main/).
...
This repo is based on an idea by [@simonw](https://github.com/simonw) who created [research](https://github.com/simonw/research).